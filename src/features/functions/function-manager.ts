...
export default class FunctionManager {
     ...
     * @param actionMap
     */
    public register(functionMap: FunctionMapType<any>) {
     ...
     * @param functionName
     */
    public get<F extends typeof Function>(functionName: string) {
        // Get function
     ...
     * @param functionType
     */
    public async run<F extends typeof Function, U extends User | undefined>(
        functionType: F,
