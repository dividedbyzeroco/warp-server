...
export default class Auth {
    ...
    getSession<T extends Session>(accessToken: string): Promise<void>;
    refreshSession<T extends Session>(refreshToken: string): Promise<void>;
    revokeSession<T extends Session>(refreshToken: string): Promise<void>;
    getUser<T extends User>(accessToken: string): Promise<void>;
}
